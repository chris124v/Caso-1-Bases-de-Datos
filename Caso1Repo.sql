...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssistantPaymentErrors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssistantPaymentErrors` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantPayments` (
  ...
  CONSTRAINT `fk_AppAssitantPayments_AppAssitantPaymentErrors1`
    ...
    REFERENCES `mydb`.`AppAssistantPaymentErrors` (`PaymentErrorId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
