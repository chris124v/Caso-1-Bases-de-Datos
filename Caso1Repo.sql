...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssistanUsers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssistanUsers` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantFileTypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantFileTypes` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantFiles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantFiles` (
  ...
  CONSTRAINT `fk_AppAssitantFiles_AppAssistanUsers1`
    FOREIGN KEY (`UserId`)
    REFERENCES `mydb`.`AppAssistanUsers` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AppAssitantFiles_AppAssitantFileTypes1`
    FOREIGN KEY (`FileTypeId`)
    REFERENCES `mydb`.`AppAssitantFileTypes` (`FileTypeId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantPaymentMethods`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantPaymentMethods` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantDataPayments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantDataPayments` (
  ...
  CONSTRAINT `fk_AppAssitantDataPayments_AppAssitantPaymentMethods1`
    ...
    REFERENCES `mydb`.`AppAssitantPaymentMethods` (`PaymentMethodId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantPaymentErrors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantPaymentErrors` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantPayments` (
  ...
  `changeToken` VARBINARY(250) NOT NULL,
  `error` BIT NOT NULL,
  ...
  INDEX `fk_AppAssitantPayments_AppAssitantPaymentErrors1_idx` (`PaymentErrorId` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_AppAssitantPayments_AppAssitantDataPayments1`
    ...
    REFERENCES `mydb`.`AppAssitantDataPayments` (`DataPaymentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AppAssitantPayments_AppAssitantPaymentMethods1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AppAssitantPayments_AppAssitantPaymentErrors1`
    FOREIGN KEY (`PaymentErrorId`)
    REFERENCES `mydb`.`AppAssitantPaymentErrors` (`PaymentErrorId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantTransactionsTypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantTransactionsTypes` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantTransactionsSubTypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantTransactionsSubTypes` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantCurrencyTypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantCurrencyTypes` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantTransactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantTransactions` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantCountries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantCountries` (
  `CountryId` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(30) NOT NULL,
  `language` VARCHAR(20) NOT NULL,
  `CurrencyExchangeId` INT NOT NULL,
  PRIMARY KEY (`CountryId`),
  INDEX `fk_AppAssitantCountries_AppAssitantCurrencyExchanges1_idx` (`CurrencyExchangeId` ASC) VISIBLE,
  CONSTRAINT `fk_AppAssitantCountries_AppAssitantCurrencyExchanges1`
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantStates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantStates` (
  ...
  CONSTRAINT `fk_AppAssitantStates_AppAssitantCountries1`
    ...
    REFERENCES `mydb`.`AppAssitantCountries` (`CountryId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantCities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantCities` (
  ...
  CONSTRAINT `fk_AppAssitantCities_AppAssitantStates1`
    FOREIGN KEY (`StateId`)
    REFERENCES `mydb`.`AppAssitantStates` (`StateId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantAddress`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantAddress` (
  ...
  CONSTRAINT `fk_AppAssitantAddress_AppAssitantCities1`
    FOREIGN KEY (`CityId`)
    REFERENCES `mydb`.`AppAssitantCities` (`CityId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantLogTypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantLogTypes` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantLogSeverities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantLogSeverities` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantLogs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantLogs` (
  ...
  CONSTRAINT `fk_AppAssitantLogs_AppAssitantLogTypes1`
    ...
    REFERENCES `mydb`.`AppAssitantLogTypes` (`LogTypeId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_AppAssitantLogs_AppAssitantLogSeverities1`
    ...
    REFERENCES `mydb`.`AppAssitantLogSeverities` (`LogSeverityId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AppAssitantLogs_AppAssitantTransactions1`
    FOREIGN KEY (`TransactionId`)
    REFERENCES `mydb`.`AppAssitantTransactions` (`TransactionId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantSuscriptions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantSuscriptions` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantSuscriptionPrices` (
  ...
  CONSTRAINT `fk_AppAssitantSuscriptionPrices_AppAssitantSuscriptions1`
    ...
    REFERENCES `mydb`.`AppAssitantSuscriptions` (`SuscriptionsId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantLanguages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantLanguages` (
...
-- -----------------------------------------------------
-- Table `mydb`.`AppAssitantTranslations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssitantTranslations` (
  ...
  CONSTRAINT `fk_AppAssitantTranslations_AppAssitantLanguages1`
    ...
    REFERENCES `mydb`.`AppAssitantLanguages` (`LanguagesId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`AppAssistantUserAddresses` (
  ...
  CONSTRAINT `fk_AppAssistantUserAddresses_AppAssitantAddress1`
    ...
    REFERENCES `mydb`.`AppAssitantAddress` (`AddressId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
